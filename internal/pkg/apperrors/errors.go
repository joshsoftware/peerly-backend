...
func GetHTTPStatusCode(err error) int {
	...
	case OrganizationNotFound, InvalidParentValue, InvalidOrgId, GradeNotFound, AppreciationNotFound, PageParamNotFound:
		return http.StatusNotFound
	case BadRequest, InvalidId, JSONParsingErrorReq, TextFieldBlank, InvalidCoreValueData, DescFieldBlank, UniqueCoreValue, RepeatedUser, SelfAppreciationError, InvalidCoreValueID, InvalidReceiverID:
